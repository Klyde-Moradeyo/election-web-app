...
(function() {
  ...
  var getPercentageWidths = function(warehouse, table, tableSize) {
    return getWidthFrom(warehouse, table, getPercentageWidth, function(
      deduced
    ) {
      return deduced.fold(
        function() {
  ...
  var getPixelHeights = function(warehouse, table, direction) {
    return getHeightFrom(warehouse, table, direction, getHeight, function(
      deduced
    ) {
  ...
  var isEditable$1 = function(element, assumeEditable) {
    ...
    if (!detect$3().browser.isIE() && inBody(element)) {
      ...
      return closest(element).fold(constant(assumeEditable), function(
        editable
      ) {
  ...
  var getSelectionTargets = function(editor, selections) {
    ...
    var findTargets = function() {
      return getStart().bind(function(startCellOrCaption) {
        return flatten(
          lift2(table(startCellOrCaption), getEnd().bind(table), function(
            startTable,
            endTable
          ) {
