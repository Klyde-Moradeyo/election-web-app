...
!(function() {
  ...
  function ll(e, n) {
    ...
    return {
      ...
      bordercolor: Gn(t, "border-color")
        .map(cl(e))
        .getOr(""),
      backgroundcolor: Gn(t, "background-color")
        .map(cl(e))
        .getOr("")
    };
  }
  ...
  function zs(n, t, e) {
    var r,
      ...
      i = u,
      c = t;
    return ((r = n).point(i) > c.getInnerHeight()
