...
!(function() {
  ...
  function Cf(r, l) {
    ...
    function o(e) {
      ...
      N ||
        l.removed ||
        (O(T.select("img[data-mce-selected],hr[data-mce-selected]"), function(
          e
        ) {
          e.removeAttribute(D);
        }),
  ...
  function Sg(e, t, n) {
    ...
    if (m.isDefaultPrevented())
      ...
      h === v &&
        ...
        (p = v.firstChild) && !e.schema.getShortEndedElements()[p.nodeName] &&
      ...
      editor: {
        getContent: function(e, t) {
          return (
            ...
            ve
              .from(d.getBody())
              .fold(J("tree" === m.format ? new Ud("body", 11) : ""), function(
                e
              ) {
                return (
                  (t = d),
    ...
    return L(
      ...
      function(e, o) {
        return e.fold(
          ...
          function(r) {
            return dn(Q(r.getClientRects()), Q(o.getClientRects()), function(
              e,
              t
            ) {
  ...
  function c0(r, o, i, a) {
    ...
    r.undoManager.ignore(function() {
      ...
      r.selection.setRng(
        ...
        Qb(s, u, as.fromRangeStart(r.selection.getRng()))
          .map(ty)
          .map(s0(r, o));
    }),
      r.nodeChanged();
        ...
        if (f(c))
          return (function(e) {
            ...
            var r = (function(e, t, n) {
              ...
              o = Nt.fromDom(e);
            return (
              Y(hu(Nt.fromDom(l.getBody()), "*[data-mce-selected]"), function(
                e
              ) {
                je(o, e) || yn(e, S);
              }),
