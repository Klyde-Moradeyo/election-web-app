...
(function() {
  ...
  var doCreate = function(
    ...
    var me = __assign(__assign(__assign({}, wrappedExtra), wrappedApis), {
      ...
      exhibit: function(info, base) {
        return lift2(getConfig(info), get$c(active, "exhibit"), function(
          behaviourInfo,
          exhibitor
        ) {
  ...
  var getFirst = function(component, hConfig, _hState) {
    return descendant(component.element, "." + hConfig.itemClass).bind(function(
      e
    ) {
      return component
        .getSystem()
  ...
  var doMove$2 = function(cycle) {
    return function(element, focused, gridConfig, gridState) {
      return locateVisible(element, focused, gridConfig.selector).bind(function(
        identified
      ) {
        return cycle(
  ...
  var subs = function(owner, detail, parts) {
    ...
    each$1(parts, function(part) {
      part.fold(
        function(data) {
          internals[data.pname] = single$2(true, function(
            detail,
            partSpec,
            partValidated
          ) {
        ...
        function(data) {
          internals[data.pname] = single$2(false, function(
            detail,
            partSpec,
            partValidated
          ) {
  ...
  var init$2 = function() {
    ...
    var getTriggeringPath = function(itemValue, getItemByValue) {
      var extraPath = filter$2(lookupItem(itemValue).toArray(), function(
        menuValue
      ) {
